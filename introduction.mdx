...
description: "TypeScript SDK for detecting multi-author synchronized pump signals in crypto, with path-aware exit replay and liquidation-cascade detection."
---

...
<CardGroup cols={2}>
  <Card title="moonbag / gravebag" icon="triangle-exclamation" href="/concepts/liquidation-cascade">
  ...
  <Card title="Trailing take" icon="chart-line" href="/concepts/exit-tensor">
  ...
  <Card title="Peak staleness" icon="clock" href="/concepts/exit-tensor">
  ...
  <Card title="Life-cap" icon="stopwatch" href="/concepts/exit-tensor">

...
description: "How pump-anomaly trains and resolves exit parameters (trailing take, hard stop, impact horizon) per channel, symbol, direction, and volume regime."
---

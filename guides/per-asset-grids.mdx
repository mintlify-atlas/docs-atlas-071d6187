---
title: "Per-Asset Training Grids for 15 Supported Cryptocurrencies"
sidebarTitle: "Per-Asset Grids"
description: "Pre-tuned TrainGrid configs for BTC, ETH, SOL, DOGE, BNB, XRP, and more — covering pump speed, stop tightness, cascade detection, and matrix strictness."
---
...
<CardGroup cols={2}>
  <Card title="Memecoins (Fartcoin, HYPE, SOL)" icon="bolt" href="/guides/per-asset-grids">
  ...
  <Card title="Majors (BTC, ETH, XRP, LTC, XLM, LINK, DOT)" icon="building-columns" href="/guides/per-asset-grids">

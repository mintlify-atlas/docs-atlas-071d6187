...
description: "Learn how pump-anomaly certifies a real edge using DSR, PBO, SPA, minTRL, and nested OOS — five independent barriers against backtest overfitting."
---
...
<CardGroup cols={2}>
  <Card title="reliable: true" icon="database" href="/guides/training">
  ...
  <Card title="certified: true" icon="shield-check" href="/guides/certification">

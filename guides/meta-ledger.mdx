---
title: "Meta-Ledger: Guard Against Overfitting Across Repeated Fits"
sidebarTitle: "Meta-Ledger"
description: "Use MetaLedger to prevent meta-level winner's-curse: enforce a refit cadence and apply a family-wise DSR correction across all PumpMatrix.fit() attempts."
---
...
<CardGroup cols={2}>
  <Card title="Cadence Guard" icon="clock" href="/guides/meta-ledger">
  ...
  <Card title="Family-Wise DSR Correction" icon="calculator" href="/guides/meta-ledger">
...
The first call on an empty ledger is always allowed (`reason: "первый fit"`). Subsequent calls are allowed only after `minRefitMs` has elapsed since the last logged attempt.

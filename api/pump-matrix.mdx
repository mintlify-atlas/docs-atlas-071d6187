...
description: "PumpMatrix API: fit() trains the model, load() restores it, signals() and plan() drive live trades, backtest() replays history, getters expose diagnostics."
---

---
title: "TradeSignal and BacktestSignal Type Reference"
sidebarTitle: "TradeSignal"
description: "Complete field reference for TradeSignal, BacktestSignal, BacktestResult, ExitPlan, and SignalOrigin — the output types of plan(), signals(), and backtest()."
---
...
<ResponseField name="reason" type="string" required>
  ...
  - `"no-candles"` — no candle data was available (entered is false)
</ResponseField>
